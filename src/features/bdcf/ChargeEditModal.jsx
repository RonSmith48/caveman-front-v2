...
const ChargeEditModal = ({ open, onClose, location_id, handleSelectOredrive, od }) => {
  ...
  return (
    <Dialog open={open} onClose={onClose} fullScreen>
                  ...
                  <Grid container spacing={2} sx={{ pt: 1 }}>
                    ...
                    <Grid item xs={12}>
                      <Box display="flex" justifyContent="flex-start" gap={2}>
                        <Button onClick={handleUnchargeClick} variant="outlined" color="warning">
                          UnCharge
                        </Button>
      ...
      <Dialog open={openUnchargeConfirm} onClose={handleCancelUncharge} maxWidth="sm" fullWidth>
        <DialogTitle>Confirm UnCharge</DialogTitle>
        <DialogContent>
          <Typography>
            ⚠️ **<b>Warning:</b>** Uncharging this ring will remove its charge data. This **<b>cannot be undone</b>** except by re-entering
            the details.
          </Typography>
        </DialogContent>
        <DialogActions>
